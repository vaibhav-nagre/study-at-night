alert("Click on the switches and the book!");
alert(
  "Please don't mind if it looks a bit weird due to different device width and height \nCreated By: Vaibhav Nagre"
);
